...
class Playlist extends React.Component {
    ...
    componentWillUnmount() {
        ...
        PlayerStore.removeListener(
            'clientUpdateMediaPlaylistLoading',
            this.onClientUpdateMediaPlaylistLoading
        )
        PlayerStore.removeListener(
            'clientUpdateMediaTitleMouseOver',
            this.onClientUpdateMediaTitleMouseOver
        )
    }
        ...
        return (
            <div className='playlist'>
                <div className={classNames('playlist-wrapper', classes.root, classes.borderColor)}>
                    <Scrollbar containerRef={this.onListRef} onScrollY={this.handleScroll}>
                        <div
