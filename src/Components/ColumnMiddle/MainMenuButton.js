...
import { currentChatClearHistory } from '../../Stores/ReduxStore/actions'
    ...
    handleScheduledAction = (chatId, clientUpdateType, message, request) => {
        ...
        const action = async () => {
            try {
                ...
                this.props.dispatch(currentChatClearHistory())
            } finally {
        ...
        return (
            <>
                ...
                <Menu
                    ...
                    {clearHistory && (
                        <MenuItem onClick={this.handleClearHistory}>Clear history</MenuItem>
                    )}
