...
class StickersHint extends React.Component {
    ...
    componentWillUnmount() {
        StickerStore.removeListener(
            'clientUpdateLocalStickersHint',
            this.onClientUpdateLocalStickersHint
        )
        StickerStore.removeListener(
            'clientUpdateRemoteStickersHint',
            this.onClientUpdateRemoteStickersHint
        )
    }
    ...
    loadPreviewContent = stickerId => {
        ...
        if (this.hintsRef && this.hintsRef.current) {
            stickersPerRow = Math.floor(
                this.hintsRef.current.clientWidth / STICKER_HINT_DISPLAY_SIZE
            )
        }
    ...
    render() {
        ...
        return (
            <div
                ...
                <Scrollbar className={'stickers-hint-content'}>
                    {controls}
