...
class MediaViewer extends React.Component {
    ...
    onUpdateMessageContent = async update => {
        ...
        await loadMediaViewerContent([message])
    ...
    loadHistory = async () => {
        ...
        if (index === -1) {
            ...
            await preloadMediaViewerContent(0, this.history)
        } else {
            await preloadMediaViewerContent(index, this.history)
    ...
    saveAnimation = (animation, message) => {
        ...
        saveOrDownload(file, file_name || id, message, () =>
            FileStore.updateAnimationBlob(chat_id, id, fileId)
        )
    }
    ...
    saveDocument = (document, message) => {
        ...
        saveOrDownload(file, file_name || id, message, () =>
            FileStore.updateDocumentBlob(chat_id, id, fileId)
        )
    }
    ...
    saveVideo = (video, message) => {
        ...
        saveOrDownload(file, file_name || id, message, () =>
            FileStore.updateVideoBlob(chat_id, id, fileId)
        )
    }
    ...
    savePhoto = (photo, message) => {
        ...
        saveOrDownload(file, file.id + '.jpg', message, () =>
            FileStore.updatePhotoBlob(chat_id, id, fileId)
        )
    }
    ...
    loadMedia = async (index, callback) => {
            ...
            <div className={classNames('media-viewer', background)}>
                ...
                <div className='media-viewer-footer'>
                    ...
                    <MediaViewerFooterText
                        title={title}
                        subtitle={
                            maxCount && index >= 0 ? `${maxCount - index} of ${maxCount}` : null
                        }
                    />
