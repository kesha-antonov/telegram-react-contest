...
module.exports = __webpack_require__.p + "ef5b7375afcb3e32ba4066a0003c699c.wasm";

/***/ }),
/* 7 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "9b41445de53ef6f64625b599196604f5.mem";
          ...
          case 0:
            ...
            memoryDriver = {
              ...
              getItem: function () {
                ...
                /*#__PURE__*/
                regenerator_default.a.mark(function _callee19(key) {
                  var value;
              ...
              iterate: function () {
                ...
                /*#__PURE__*/
                regenerator_default.a.mark(function _callee20(iteratorCallback) {
              ...
              key: function () {
                ...
                /*#__PURE__*/
                regenerator_default.a.mark(function _callee21(n) {
                  ...
                  return regenerator_default.a.wrap(function _callee22$(_context22) {
                    while (1) {
                      switch (_context22.prev = _context22.next) {
                        case 0:
                          return _context22.abrupt("return", this._map.keys());
                  ...
                  return regenerator_default.a.wrap(function _callee23$(_context23) {
                    while (1) {
                      switch (_context23.prev = _context23.next) {
                        case 0:
                          return _context23.abrupt("return", this._map.size());
              ...
              removeItem: function () {
                ...
                /*#__PURE__*/
                regenerator_default.a.mark(function _callee24(key) {
              ...
              setItem: function () {
                ...
                /*#__PURE__*/
                regenerator_default.a.mark(function _callee25(key, value) {
                  var originalValue;
                    ...
                    while (1) {
                      switch (_context25.prev = _context25.next) {
                        case 0:
                          ...
                          return _context25.abrupt("return", originalValue);
...
function _loadTdlibWasm() {
  ...
  /*#__PURE__*/
  regenerator_default.a.mark(function _callee27(onFS) {
          ...
          case 3:
            ...
            module = Module["default"]({
              ...
              instantiateWasm: function instantiateWasm(imports, successCallback) {
                logger.info('start instantiateWasm');
            ...
            return _context27.abrupt("return", TdModule);
...
function _loadTdlibAsmjs() {
  ...
  /*#__PURE__*/
  regenerator_default.a.mark(function _callee28(onFS) {
      ...
      while (1) {
        switch (_context28.prev = _context28.next) {
          ...
          case 3:
            ...
            return _context28.abrupt("return", TdModule);
...
function _loadTdlib() {
  ...
  /*#__PURE__*/
  regenerator_default.a.mark(function _callee29(mode, onFS) {
    var wasmSupported;
          ...
          case 0:
            ...
            if (!wasmSupported) {
              if (mode === 'wasm') {
                ...
                logger.warning('WebAssembly is not supported, trying to use asm.js');
                mode = 'asmjs';
              }
            }
            ...
            return _context29.abrupt("return", loadTdlibAsmjs(onFS));

          case 4:
            return _context29.abrupt("return", loadTdlibWasm(onFS));
...
function () {
  ...
  createClass_default()(InboundFileSystem, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee2(pid, path, arr) {
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return this.store.setItem(pid, new Blob([arr]));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee3(pid) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                this.forget(pid);
                _context3.next = 5;
                return this.store.removeItem(pid);
              ...
              case 7:
                ...
                logger.error('Failed unlink ' + pid + ' ', _context3.t0);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee4(dbName, root, FS_promise) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                ifs.root = root;
                ifs.store = localforage_default.a.createInstance({
                  name: dbName,
              ...
              case 8:
                ...
                return _context4.abrupt("return", ifs);

              case 16:
                _context4.prev = 16;
                _context4.t0 = _context4["catch"](1);
                logger.error('Failed to init Inbound FileSystem: ', _context4.t0);
...
function () {
  ...
  createClass_default()(DbFileSystem, [{
              ...
              case 2:
                ...
                return new Promise(function (resolve, reject) {
                  _this.FS.syncfs(false, function () {
                    ...
                    _this.syncfs_total_time += syncfs_time;
                    logger.debug('SYNC: ' + syncfs_time);
                    logger.debug('SYNC total: ' + _this.syncfs_total_time);
                    resolve();
                  });
                });
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee8(root, FS_promise) {
        var readOnly,
            start,
            dbfs,
            FS,
        ...
        return regenerator_default.a.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                readOnly = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : false;
                start = performance.now();
                _context8.prev = 2;
              ...
              case 15:
                ...
                _context8.t0 = regenerator_default.a.keys(root_dir.node.contents);
              ...
              case 35:
                ...
                logger.error('Failed to init DbFileSystem: ', _context8.t2);
...
function () {
  ...
  createClass_default()(TdFileSystem, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee10(prefix, FS_promise) {
        var FS;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 2:
                FS = _context10.sent;
                FS.mkdir(prefix);
                return _context10.abrupt("return", FS);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee11(instanceName, FS_promise) {
        var readOnly,
            tdfs,
            prefix,
            inboundFileSystem,
        ...
        return regenerator_default.a.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 15:
                tdfs.inboundFileSystem = _context11.sent;
                _context11.next = 18;
                return dbFileSystem;

              case 18:
                tdfs.dbFileSystem = _context11.sent;
                return _context11.abrupt("return", tdfs);

              case 22:
                _context11.prev = 22;
                _context11.t0 = _context11["catch"](1);
                logger.error('Failed to init TdFileSystem: ', _context11.t0);
...
function () {
  ...
  createClass_default()(TdClient, [{
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 2:
                ...
                _context13.next = 13;
                return loadTdlib(mode, this.onFS);

              case 13:
                this.TdModule = _context13.sent;
                ...
                this.td_functions = {
                  ...
                  td_set_verbosity: function td_set_verbosity(verbosity) {
                    _this2.td_functions.td_execute(0, JSON.stringify({
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee14(last_update) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee15(result) {
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 7:
                ...
                logger.error('Failed destroy', _context15.t0);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee16(error) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee17(pid, file, arr) {
      ...
      function doSaveFile(_x22, _x23, _x24) {
